"""
Load transformed .parquet files from S3 to analytics.dim_sensr table to Snowflake.
"""
# ### IMPORTS ###
...
SNOWFLAKE_TABLE = "dim_sensor"
S3_STAGE_NAME = "@CLEAN_AIR_DB.PROCESSED.dim_sensor_stage"
