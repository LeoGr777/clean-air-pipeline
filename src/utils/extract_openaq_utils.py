...
def fetch_all_pages_new(endpoint: str, params: dict = None) -> list[dict]:
    ...
    while True:
        ...
        try:
            ...
            logging.info(f"Page {page}: fetched {num_items} items (total: {num_all_items})")
...
def upload_to_s3(s3_client: boto3.client, bucket_name: str, endpoint: str, data: list[dict], file_prefix="data"):
    """
...
def upload_bytes_to_s3(s3_client: boto3.client, bucket_name: str, s3_key: str, data_bytes: bytes):
    """
